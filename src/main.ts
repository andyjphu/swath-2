...
import { generateEuropeMap } from './map/EuropeMapData';
...
async function init() {
  ...
  await generateEuropeMap(tileMap, rivers);
  console.log('Map generated.');

  // Center camera on Europe (roughly center of map, slightly right and up)
  camera.zoom = 0.5;
